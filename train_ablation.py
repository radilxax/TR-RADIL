...
def main():
    ...
    parser.add_argument('--no_spatial_attn', action='store_true', help='去掉空间注意力')
    parser.add_argument('--no_temporal_transformer', action='store_true', help='去掉时序Transformer')
    parser.add_argument('--no_temporal_attn', action='store_true', help='去掉时序注意力池化')
    parser.add_argument('--no_aux_task', action='store_true', help='去掉辅助任务')
    parser.add_argument('--no_clinical', action='store_true', help='去掉临床特征')
    parser.add_argument('--no_interaction', action='store_true', help='去掉交互特征(diff/prod)')
    parser.add_argument('--no_interval_embed', action='store_true', help='去掉时间间隔嵌入')
    ...
    summary_path = save_dir / 'ablation_results_v2.txt'
